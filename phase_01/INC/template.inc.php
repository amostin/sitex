...
<!--[if gt IE 8]><!--> <html class="no-js" lang="fr"> <!--<![endif]-->
    <head>
        ...
        <script src="JS/All/mo/modernizr-2.8.3-respond-1.4.2.min.js"></script>

        <script src="JS/All/jQ/jquery-1.11.2.min.js"></script>
    ...
    <body>
        ...
        <div class="header-container">
            <header class="wrapper clearfix">
                <div class="ico">
                    <img class="icone" src="IMG/template.jpg" alt="logo" />
                </div>
